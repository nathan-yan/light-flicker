...
bool RFM69OOK::initialize()
{
  ...
  Serial.print("SS Pin: "); Serial.println(_slaveSelectPin);
  Serial.print("INT Pin: "); Serial.println(_interruptPin);
  Serial.print("INT Num: "); Serial.println(_interruptNum);;
  ...
  for (byte i = 0; CONFIG[i][0] != 255; i++) {
    Serial.print("writing "); Serial.print(readReg(CONFIG[i][0])); Serial.print(" "); Serial.println(CONFIG[i][1]);
    writeReg(CONFIG[i][0], CONFIG[i][1]);
    delay(200);
    Serial.println(readReg(CONFIG[i][0]));
  }
